// ===== Trade Pulse AI – main.js (FULL with admin toggle + forced demo, no-lag fix, guards on final confirm) =====
(function() {
  ...
  function bindWithdrawFormEvents() {
    ...
    if (requestBtn) {
      requestBtn.addEventListener('click', () => {
        if (blockIfForcedDemo()) return; // forced demo guard
  ...
  // Bottom nav and drawer navigation with forced demo guard
  document.querySelectorAll('.nav-item[data-view]').forEach(b => {
    b.addEventListener('click', function(e) {
      const view = this.dataset.view;
      if (view === 'withdraw' && blockIfForcedDemo()) return;
      setView(view);
    });
  });
  ...
  document.addEventListener('click', function(e) {
    ...
    if (nav && nav.dataset.nav) {
      if (nav.dataset.nav === 'withdraw' && blockIfForcedDemo()) return;
